...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white">
      ...
      <div className="relative mx-auto flex max-w-[1440px] flex-col gap-[2.375rem] border-b border-b-white/10 py-[3.125rem] text-center lg:gap-[3.125rem] lg:py-20 xl:flex-row xl:justify-between xl:px-[3.75rem] xl:py-[10rem] xl:text-left 2xl:px-0">
        <img
