    ...
    >
      ...
      <Container>
        <div className="flex items-center justify-between py-6 lg:py-8">
          ...
          >
            <span className="split">Back to top</span>
      ...
      <div className="border-b border-t border-b-white/10 border-t-white/10">
        <div className="relative mx-auto flex max-w-[1440px] flex-col gap-[2.375rem] py-[3.125rem] text-center lg:gap-28 lg:py-20 min-[1180px]:flex-row min-[1180px]:justify-between min-[1180px]:px-[3.75rem] min-[1180px]:py-[10rem] min-[1180px]:text-left 2xl:px-0">
          <img
          ...
          <div className="relative z-10 flex flex-col gap-[1.375rem] border-b border-b-white/10 px-6 pb-[2.375rem] lg:gap-10 lg:px-8 min-[1180px]:gap-[2.6875rem] min-[1180px]:border-b-transparent min-[1180px]:px-0 min-[1180px]:pb-0">
            ...
            <p className="split text-lg font-semibold text-grey lg:text-xl min-[1180px]:text-[1.375rem]">
          ...
          <div className="relative z-10">
            ...
            <div className="px-6 lg:px-8 min-[1180px]:px-0">
              <span className="split mb-2.5 mt-[2.75rem] block text-sm font-semibold text-grey lg:mb-3.5 lg:text-[0.9375rem] min-[1180px]:mt-[4.375rem]">
                Contact me
              </span>
              <a
