      ...
      <Container>
        <div className="grid-cols-3 items-center md:grid">
          <div className="flex w-full items-center justify-between">
            <span className="cursor-pointer text-primary">[izzy]</span>
            <span
              className="md:hidden"
          ...
          <div
            className={cn(
              ...
              isOpen
                ? "-translate-y-0"
                : "-translate-y-[125%] md:translate-y-0",
            )}
          >
            <div className="absolute left-0 top-[50px] grid w-full place-items-center md:static md:left-auto md:top-auto md:flex md:items-center md:justify-between">
              <ul className="mb-12 flex flex-col gap-12 text-center md:mb-0 md:flex-row">
                <li>
